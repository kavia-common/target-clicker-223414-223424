...
Set the following variables before running locally:
...
Notes:
- The service listens on port 3001 by default (see server.port in application.properties).
- CORS origins map to property app.cors.allowed-origins and are read by CorsConfig.
